...
const MEMBER_DEFS = {
  capanga: {
    ...
    hours: 2,
    casualtyWeight: 1.05,
    base: { rajada: 7, blindagem: 6, folego: 7, quebra: 6 },
    special: {},
  },
  frente: {
    recruit: 1800,
    ...
    hours: 3,
    casualtyWeight: 1.15,
    base: { rajada: 9, blindagem: 6, folego: 8, quebra: 7 },
    special: {},
  },
  executor: {
    recruit: 2600,
    ...
    hours: 4,
    casualtyWeight: 1.1,
    base: { rajada: 9, blindagem: 6, folego: 7, quebra: 9 },
    special: {},
  },
  assassino: {
    recruit: 3200,
    ...
    hours: 4,
    casualtyWeight: 1.25,
    base: { rajada: 10, blindagem: 4, folego: 6, quebra: 9 },
    special: {},
  },
  muralha: {
    recruit: 3000,
    ...
    hours: 4,
    casualtyWeight: 0.8,
    base: { rajada: 4, blindagem: 10, folego: 10, quebra: 4 },
    special: {},
  },
  certeiro: {
    recruit: 2800,
    ...
    hours: 4,
    casualtyWeight: 1.15,
    base: { rajada: 9, blindagem: 4, folego: 6, quebra: 7 },
    special: {},
  },
  motorista: {
    recruit: 2300,
    ...
    hours: 3,
    casualtyWeight: 1.0,
    base: { rajada: 6, blindagem: 6, folego: 7, quebra: 7 },
  ...
  nitro: {
    ...
    hours: 3,
    casualtyWeight: 1.1,
    base: { rajada: 8, blindagem: 4, folego: 6, quebra: 6 },
  ...
  armeiro: {
    ...
    hours: 3,
    casualtyWeight: 1.0,
    base: { rajada: 6, blindagem: 5, folego: 6, quebra: 8 },
  ...
  informante: {
    ...
    hours: 3,
    casualtyWeight: 1.2,
    base: { rajada: 5, blindagem: 4, folego: 6, quebra: 5 },
  ...
  wifi: {
    ...
    hours: 3,
    casualtyWeight: 1.15,
    base: { rajada: 3, blindagem: 4, folego: 6, quebra: 3 },
  ...
  medico: {
    ...
    hours: 4,
    casualtyWeight: 0.95,
    base: { rajada: 2, blindagem: 4, folego: 9, quebra: 2 },
  ...
  lavador: {
    ...
    hours: 3,
    casualtyWeight: 1.05,
    base: { rajada: 2, blindagem: 4, folego: 7, quebra: 2 },
  ...
  negociador: {
    ...
    hours: 3,
    casualtyWeight: 1.05,
    base: { rajada: 2, blindagem: 5, folego: 6, quebra: 2 },
...
function getFormationBonus(formation) {
  return FORMATION_BONUSES[formation] || FORMATION_BONUSES.pressao_total;
}
...
export function resolveGangCasualties({
  ...
  const rawLossRateBeforeFormation = clamp(
  ...
  const rawLossRate = clamp(
    rawLossRateBeforeFormation *
      (1 - formationBonus.casualtyReductionPercent / 100),
    0.04,
    0.65
  );
  ...
  const sortedTargets = [...ativos].sort(
    (a, b) => MEMBER_DEFS[b.type].casualtyWeight - MEMBER_DEFS[a.type].casualtyWeight
  );

  const medicalSaveChance = clamp(
    0.18 +
      ownStats.medicalPower * 0.0025 +
...
export function serializeGang(doc, player) {
  const maxMembers = getGangMaxMembers(
    doc.ct.level,
